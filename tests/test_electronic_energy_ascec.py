...
def test_ElectronicEnergy_object_system_initial_grep(
    ...
    Parameters
        ...
        basis : string
            Label of the basis set
    """
    assert ElectronicEnergy(
        Cluster(cluster1, cluster2),
        method_min,
        sphere_center,
        sphere_radius,
        basis,
    )._object_system_initial == Cluster(cluster1, cluster2)
...
def test_ElectronicEnergy_object_system_before_grep(
    ...
    assert ElectronicEnergy(
        ...
        sphere_radius,
        basis,
    )._object_system_before == Cluster(cluster1, cluster2)
...
def test_ElectronicEnergy_object_system_current_grep(
    ...
    assert ElectronicEnergy(
        ...
        sphere_radius,
        basis,
    )._object_system_current == Cluster(cluster1, cluster2)
