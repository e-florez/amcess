...
#         overlap.append(
#             Cluster().Overlapping(
#                 mol1.GetAtomicCoordinates(), mol2.GetAtomicCoordinates()
#             )
#         )
...
#     assert (
#         mol.GetAtomicCoordinates()[3].all()
...
#     assert mol.GetAtomicCoordinates().all() == mol_rotated.GetAtomicCoordinates().all()
